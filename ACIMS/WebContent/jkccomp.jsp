...
<tr><td height="30"><center><font color="#0077c0"><h3>LIST OF COMPANIES</h3></font>
		  ...
		  while(rs2.next())
			{
			  ...
			  %>
			  <tr><td bgcolor="#EFEFEF" height=20 align=center><input type=hidden name=<%=ss%> value=<%=x%>><%=x%></td><td bgcolor="#EFEFEF" height=20 align=center><input type=hidden name=<%=sss%> value=<%=y%>><%=y%></td><td bgcolor="#EFEFEF" height=20 align=center><input type=hidden name=<%=s%>> <a href="getdetails.jsp?z=<%=x%>&&w=<%=y%>"><%=rs2.getString(3)%></a></td>
</tr>
<%
