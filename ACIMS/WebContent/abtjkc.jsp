...
<TD vAlign=top bgcolor=white height=350 >
 ...
 <tr><td align=center><P><B><FONT color=#145da6 size=4>Jawahar Interns Program</FONT></B></P></td></tr>
<tr><td><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                        color=#000000 size=2>*  The Jawahar Interns Program is to enable the better learning environments in the colleges by promoting best practices through talented Jawahar Interns and build better learning environments. 
<tr><td><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                        color=#000000 size=2>*  To provide opportunity to students to earn while learn through propagation 
<tr><td><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                        color=#000000 size=2>*  An Intern will have opportunity to work on latest technologies and updated curricula with Industry Requirements.
<tr><td><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                        color=#000000 size=2>*  An Intern will have opportunity to work closely with JKC and local government administration 
<tr><td><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                        color=#000000 size=2>*  Companies Academic Initiative training benefits will be passed to Jawahar Interns through IEG Mentors. 
<tr><td><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                        color=#000000 size=2>* Jawahar Interns will get opportunity to interact with Government Officers for developing e-Gov applications.
