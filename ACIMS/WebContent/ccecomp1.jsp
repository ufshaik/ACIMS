...
<TR>
                            ...
                            <FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=#ffffff size=2>
                             <a class=links href="jkcreglistmain.jsp">JKC  Students</FONT></TD></TR>
...
<TR>
                            ...
                            <FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=#ffffff size=2>
                             <a class=links href="abtjkc.jsp">Back</FONT></TD></TR>
...
<tr><td bgcolor="A9C6E2" height=20 align=center>Name of the company</td><td bgcolor="A9C6E2" height=20 align=center width=20%>Year</td><td bgcolor="A9C6E2" height=20 align=center>Number of students selected</td></tr><tr>
<%  int i=1;
		  ...
		  while(rs2.next())
			{
			  ...
			  %>
			  <tr><td bgcolor="#EFEFEF" height=20 align=center><input type=hidden name=<%=ss%> value=<%=x%>><%=x%></td><td bgcolor="#EFEFEF" height=20 align=center><input type=hidden name=<%=sss%> value=<%=y%>><%=y%></td><td bgcolor="#EFEFEF" height=20 align=center><input type=hidden name=<%=s%>> <a href="getdetailscce.jsp?z=<%=x%>&&w=<%=y%>"><%=rs2.getString(3)%></a></td>
</tr>
<%
