...
<tr><td><table width="800" border="1" bgcolor=white >
<tr><td valign=left width="200" class=ma>
...
<tr><td height=15></td></tr>
<tr>
<td bgcolor="0077c0" width="33%" align=center><a style="color: white" class=link1 href="deleteid.jsp?v=0">delete student</a></td>
<td bgcolor="0077c0" width="33%" align=center><a style="color: white" class=link1  href="deletestaff.jsp?v=0">delete staff</a></td>
<td bgcolor="0077c0" width="33%" align=center><a style="color: white" class=link1  href="deleteall.jsp?v=0">delete all</a></td>
...
<tr><td height="30" align=top></td></tr>


<form action="deleteid1.jsp" method="post">

<tr><td align=center>

<%if(vv.equals("1"))
	     {%><font color="red" size=3px>Record Deleted</font><%}
		 if(vv.equals("2"))
	     {%><font color="red" size=3px>Registration id not found</font><%}%>

	  </td></tr>
	  <tr><td height="50" align=top></td></tr>

	  <tr><td align=center><h4><font color="#336699">Enter student registration-id to delete student details</font></h4></td></tr>

<tr><td height="30" align=top>

<table align=center>

<tr><td height="10"></td></tr>
<tr><td>Registraion Id:</td><td><input  type="text" name="delid" size=20 ></td></tr>


<tr><td height="20"></td></tr>
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type=SUBMIT size=5 name=s1 value="Delete"></td>
<td height="27">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=reset name=r1 value="Reset"></td></tr><tr><td height="24"></td></tr>
