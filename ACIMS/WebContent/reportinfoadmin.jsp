...
<tr><td width="822" height="10"><IMG height=40 src="img/m021.jpg" width=326 ><A href="index.html" 
 ...
 onmouseover="openMenu('naac',this,260,0);" 
  onmouseout="closeMenu('naac',this);" 
  ><IMG 
  onmouseover="this.src='img/buttons/naac.gif'" onmouseout="this.src='img/buttons/naac1.gif'" 
  alt=NAAC 
...
<tr><td vAlign=center align=middle rowSpan=2>
    ...
    <TR>
                            ...
                            <FONT 
                              ...
                              color=#ffffff size=2>
                             <a class=links href="admin.jsp">Home </FONT></TD></TR>
   ...
   <TR>
                            ...
                            <FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=#ffffff size=2>
                             <a class=links href="newrequests.jsp">New Requests(<%=rs3.getString(1)%>)</FONT></TD></TR>
   ...
   <IMG height=1 src="D2_Blueline.gif" width="98%"></TD></TR>
    <TR>
                            ...
                            <FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=#ffffff size=2>
                             <a class=links href="changegrade.jsp">Change Grade</FONT></TD></TR>
    ...
    <TR>
     ...
     <TR>
                            ...
                            <FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=#ffffff size=2>
                             <a class=links href="accrproc.html">Student Information</FONT></TD></TR>
...
<TR>
                            ...
                            <FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=#ffffff size=2>
                             <a class=links href="criteria.html">Scholarships</FONT></TD></TR>
...
<TR>
                            ...
                            <FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=#ffffff size=2>
                             <a class=links href="grade.html">Selected Students</FONT></TD></TR>
...
<TR>
                            ...
                            <FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=#ffffff size=2>
                             <a class=links href="ccechangepwsd.jsp">Change Password</FONT></TD></TR>
<TR><TD vAlign=center align=middle colSpan=2>
<IMG height=1 src="D2_Blueline.gif" width="98%"></TD></TR>
<TR>
                            <TD vAlign=center height=22>&nbsp;&nbsp;<IMG height=5
