...
{ 
	...
	jre=con.prepareStatement("select count(*) from jkcdata where status=0");
	 ...
	 aci=con.prepareStatement("select roll from jkcdata where status='1'");
     rs=aci.executeQuery();
...
<%if(vv.equals("1"))
{%><center><font color=green size=4px>Record updated</font></center><br><br><%}%>
<table align=center>
<caption><font color="0077c0" size=4px><b>Enter selected sudents</b></font></caption>
<form action="jkcstu1.jsp?v=0" method=post>
<tr><td height=20></td></tr>
<tr><td>Registration-id:</td><td><select name="id">
<%String s;
    while(rs.next()){
	s=rs.getString(1);%>
...
<tr><td height=10></td></tr>
<tr><td>year of selection:</td><td><select name="year">
<%int i=1999; while(i<2020){
	%>
<option value=<%=i%>><%=i%></option>
<%i++;}%>
</select></td></tr>
<tr><td height=20></td></tr>
<tr><td align=right><input type="submit" name="Button" value=submit ></td></tr>
</form>
</table>
