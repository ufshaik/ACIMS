...
{ 
	...
	jre=con.prepareStatement("select count(*) from jkcdata where status=0");
		...
		aci=con.prepareStatement("select roll,firstname,surname,marks from jkcdata where status='0'");
        rs=aci.executeQuery();
...
<tr><td height=15></td></tr>
<tr>
<td bgcolor="0077c0" width="33%" align=center><a style="color: white" class=link1 href="jkccomp.jsp?v=0">Add Company data</a></td>
<td bgcolor="0077c0" width="33%" align=center><a style="color: white" class=link1 href="jkcviewcomp.jsp?v=0">view Company data</a></td>
<td bgcolor="0077c0" width="33%" align=center><a style="color: white" class=link1  href="deletecomp.jsp?v=0">delete Company data</a></td>
<tr><td height=50></td></tr></table>
<%if(vv.equals("1"))
	{%>
<center><font color=green size=4px>Successfully Deleted</font></center><%}%>
<%if(vv.equals("2"))
	{%>
<center><font color=green size=4px>No data Found</font></center><%}%>
<br><br>
<table align=center>
<caption><font color="#0077c0" size=4px>Delete details</font></caption>
<form action="deleteselectcom.jsp" method="post">
<tr><td height=20></td></tr>
<tr><td>Company name:</td><td><select name="company">
<option value=infosys>Infosys</option>
<option value=ibm>IBM</option>
<option value=wipro>Wipro</option>
<option value=satyam>Satyam</option>
<option value=tech>Tech Mahendra</option>
<option value=cts>Cognizant</option>
</select></td></tr>
<tr><td height="10"></td></tr>
<tr><td>Academic year:</td><td><select name="year">
<%int i=1999;
  while(i<=2020)
  {
	   %><option value=<%=i%>><%=i%></option><%i++;}%></select></td></tr>
	   <tr><td height="20"></td></tr>
