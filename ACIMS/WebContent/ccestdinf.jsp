...
<%!
Connection con=null;
Statement stmt1,stmt2,stmt3,stmt4,log,stdinf;
 ResultSet rs=null,rs1=null,rs2=null,rs3=null,login=null,stdinfo=null;
%>
<%
try
 {
...
stdinf=con.createStatement();
  String stu="select reg_id,firstname,lastname,branch,course,marks,attend from "+ta+" where branch='"+bran+"'";
  stdinfo=stdinf.executeQuery(stu);
...
<tr height="20"><td bgcolor="a9c6e2" align="center">Reg-Id</td><td bgcolor="a9c6e2" align="center">Name</td><td bgcolor="a9c6e2" align="center">Branch</td><td bgcolor="a9c6e2" align="center">Year</td><td bgcolor="a9c6e2" align="center">Marks </td><td bgcolor="a9c6e2" align="center">Attendance</td>
<%while(stdinfo.next())
	 {
	  String fname=stdinfo.getString(2);
      	  String lname=stdinfo.getString(3);
	  String nam=fname+" "+lname;
	  %>
	   <tr height="20"><td bgcolor="efefef" align="center"><%=stdinfo.getString(1)%>
       <td bgcolor="efefef" align="center"><%=nam%>
	   <td bgcolor="efefef" align="center"><%=stdinfo.getString(4)%>
	   <td bgcolor="efefef" align="center"><%=stdinfo.getString(5)%>
	   <td bgcolor="efefef" align="center"><%=stdinfo.getString(6)%>
	   <td bgcolor="efefef" align="center"><%=stdinfo.getString(7)%>
