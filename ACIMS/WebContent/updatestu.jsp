...
<tr><td><form action="updatestu1.jsp?v=0" method="post">

<table border=0  align=center height="300">

<caption><u><font color="#336699">STUDENT DETAILS FORM</font></u></caption>
<tr><td height="10"></td></tr>

<tr><td height="10"></td></tr><tr><td height="25"><h4>Enter the Roll Number:</h4></td><td valign=top><input type=text size=15 name="t5" placeholder="Enter roll no."></td></tr>
