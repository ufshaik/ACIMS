...
<tr><td vAlign=center align=middle rowSpan=2>
   ...
   <TR>
                            ...
                            <FONT 
                              ...
                              color=#ffffff size=2>
                             <a style="color: black" class=links href="applyaccr.html">Apply For Accreditation</FONT></TD></TR>
   ...
   <IMG height=1 src="D2_Blueline.gif" width="98%"></TD></TR>
    ...
    <TR>
                            ...
                            <FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=#ffffff size=2>
                             <a style="color: black" class=links href="accrcoll.jsp">Accredited Colleges</FONT></TD></TR>
