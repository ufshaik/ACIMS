...
--
-- Host: localhost
-- Generation Time: Apr 25, 2016 at 06:50 PM
...
('SMD', 'Hyderabad', 'Hyderabad', 500078, 'Andhra Pradesh', 9642966, 40123, 'mallick@gmail.com', 'www.mallick.com'),
('A14', 'Hyderabad', 'Hyderabad', 500028, 'Andhra Pradesh', 995945, 40123, 'anwar@yahoo.com', 'www.anwar.com'),
('U12', 'Hyderabd', 'Hyderabad', 517644, 'Andhra Pradesh', 96428, 40215, 'shaik@gmail.com', 'www.shaik.com'),
('R12', 'Hyderabad', 'Hyderabad', 74586, 'Andhra Pradesh', 98745, 40563, 'richards@gmail.com', 'www.richards.com'),
('S13', 'Hyderabad', 'Hyderabad', 564899, 'Andhra Pradesh', 84127474, 4045, 'sunny@gmail.com', 'www.sunny.com');
...
('SMD', 'Arts, Science, Engineering, Management', 10, 10, 10, 10, 'B.A.,M.A,B.E.,M.B.A.'),
('A14', 'Arts, Science, Medical, Engineering', 10, 11, 12, 13, 'B.A.,B.Com.,B.Sc.'),
('U12', 'Arts, Teacher Education, Engineering', 10, 10, 10, 10, 'B.A,'),
('R12', 'Arts, Teacher Education, Engineering', 11, 12, 13, 14, 'M.SC.,M.A.,B.SC.'),
('S13', 'Arts, Commerce, Teacher Education, Physical Education, Engineering, Management', 10, 10, 10, 11, 'M.Sc.');
...
('Mallick Institute of Sciences', 'SMD', '2020-05-03', 'Osmania University', 'Mohan', 'Principal', 'A++', 'SMD', 'no'),
('Anwar Institute of Sciences', 'A14', '2020-01-02', 'Osmania University', 'Shaik Anwar Basha', 'Principal', 'A++', 'anwar', 'no'),
('Umar', 'U12', '2019-04-03', 'AICTE', 'Umar', 'Principal', 'A+', 'Shaik', 'no'),
('Richards', 'R12', '2019-05-02', 'AICTE', 'Richards', 'Principal', 'A+', 'richards', 'no'),
('Sunny', 'S13', '2019-05-03', 'Andhra Pradesh University of Health Sciences', 'Anirudh', 'Principal', 'A+', 'sunny', 'no');
...
(3, 'Shaik Umar', 'shaik_u@ymail.com', 'Error in Notifications panel');
...
('umar', 'Umar Farooq', 'Shaik', 'shaikumar0319@gmail.com', '9642966682');
...
('SHAIK', 'FAROOQ', '1608127331', 'MVSREC', '05', 80, 'umar123', 1, 'cts', 2016);
...
('anwar', 'anwar', 'college'),
('Shaik', 'Shaik', 'college'),
('richard', 'richard', 'college'),
('sunny', 'sunny', 'college'),
('richards', 'richards', 'college');
...
('1608127331', 'SHAIK', 'FAROOQ', 'Shaik Anwar Basha', 'Engineer', 'General', 'cse', 'Hyderabad', '9642966682', 'ninjas.ninjas8@gmail.com', 'A500', 1000, 70, 62, '1/jan/1970', 'male', '1/jan/1970', 60, 90, '1', 'H# 12-2-819/3, F# 504, Classic Residency Apt\r\nDilshadnagar Colony, Rethibowli'),
('1608', 'Satya ', 'Mohan', 'Mohan', 'Engineer', 'General', 'cse', 'Adilabad', '95423', 'mohan@gmail.com', '16078', 1100, 78, 89, '1/jan/2012', 'male', '1/jan/1970', 80, 0, '1', 'Hyderabad');
...
INSERT INTO `mvsrect` (`FIRSTNAME`, `LASTNAME`, `REG_ID`, `DEGREE`, `CONTACTNO`, `EMAIL_ID`, `ADDRESS`, `PROFF`, `TOTALSAL`, `CLASSSAL`, `DOB`, `GENDER`, `SUBJECT`, `MONTH`, `PRESENT`, `WORKHRS`, `SALOFMON`) VALUES
('Umar', 'Farooq', '160878', 'Mtech', 64452, 'jsdsj@gmail.com', 'Hyderabad', 'Assistant', 1100, 111, '1/jan/1970', 'male', 'asdas', 'jan', 28, 30, 878);
...
(2, '2016-04-25', '2016-04-27', 'Anwar', NULL),
(3, NULL, NULL, 'Hello', NULL);
...
('SMD', 10, 20, 13, 12, 8, 7, 8, 1255);

-- --------------------------------------------------------

--
-- Table structure for table `richardss`
--

CREATE TABLE IF NOT EXISTS `richardss` (
  `REG_ID` varchar(12) NOT NULL,
  `FIRSTNAME` varchar(30) DEFAULT NULL,
  `LASTNAME` varchar(30) DEFAULT NULL,
  `FATHERNAME` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `richardss`
--
...
--
-- Table structure for table `richardst`
--

CREATE TABLE IF NOT EXISTS `richardst` (
  `FIRSTNAME` varchar(30) DEFAULT NULL,
  `LASTNAME` varchar(30) DEFAULT NULL,
  `REG_ID` varchar(12) NOT NULL,
  `DEGREE` varchar(10) DEFAULT NULL,
...
--
-- Dumping data for table `richardst`
--
