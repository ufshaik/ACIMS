...
<tr><td vAlign=center align=middle rowSpan=2>
   ...
   <TR>
                            ...
                            <FONT 
                              ...
                              color=#ffffff size=2>
                             <a class=links href="sriram.jsp">Sriram.U</FONT></TD></TR>
   ...
   <IMG height=1 src="D2_Blueline.gif" width="98%"></TD></TR>
    ...
    <TR>
                            ...
                            <FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=#ffffff size=2>
                             <a class=links href="jagadeesh.jsp">Jagadeesh Kumar.P</FONT></TD></TR>
...
<TR>
                            ...
                            <FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=#ffffff size=2>
                             <a class=links href="naveen.jsp">Naveen Kumar.B</FONT></TD></TR>
...
<TR>
                            ...
                            <FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=#ffffff size=2>
                             <a class=links href="yamini.jsp">Yamini.K</FONT></TD></TR>
...
<tr><td height=10></td></tr>
 <tr><td align=center><P><B><FONT color=#145da6 size=4><U>Jagadeesh Kumar.P</FONT></B></P></td></tr>
<tr><td ><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                        color=#000000 size=2>
		
		<pre> <h5>      
<font color=orange face=verdana size=2px>    Telephone:</font>

        Our helpdesk is open Monday - Saturday during regular 
        College working hours.

            Call:9885897800

<font color=orange face=verdana size=2px>    Email:</font>
   
        Use our form or email us at: acims@gmail.com 

        Our policy is to respond to all feedbacks within 24 hours 
        and typically within 4 hours. 

<font color=orange face=verdana size=2px>    Postal:</font>
        
        ACIMS Website Services
        GPO Box 2838
</h5>
</pre>
