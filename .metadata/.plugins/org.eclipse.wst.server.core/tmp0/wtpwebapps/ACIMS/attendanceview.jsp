...
while(ry.next())
	...
	if(i!=1)
	{
		 response.sendRedirect("viewatt.jsp?&&v=1");
	}
...
while(rz.next())
	...
	if(j!=1)
	{
		 response.sendRedirect("viewatt.jsp?&&v=2");
	}
pst=con.prepareStatement("select reg_id,firstname,lastname,attend from "+ta+" where course=? AND branch=?");
...
<tr><td bgcolor="A9C6E2" height=20 align=center>REG_ID</td><td bgcolor="A9C6E2" height=20 align=center>NAME</td><td bgcolor="A9C6E2" height=20 align=center>Attend</td></tr>
<%while(rs.next()){%>
