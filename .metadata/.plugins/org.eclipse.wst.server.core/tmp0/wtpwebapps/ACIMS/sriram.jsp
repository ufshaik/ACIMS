...
<TD vAlign=top bgcolor=white height=350 >
 ...
 <table  >
 <tr><td align=center><P><B><FONT color=#145da6 size=4><U>SriRam.U</FONT></B></P></td></tr>
<tr><td ><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                        color=#000000 size=2>
		<pre>
		        <h5>  I am Sriram .I am Selected for Infosys
     My team project is  Accrdited College Information Management
     System.My Contibution to Project is CCE (Commissionaire/Director
     of College Education)Administrator Module, Front End Design.
 </h4>
 <h5>      
