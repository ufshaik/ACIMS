...
<td width=600 height=450 valign=top>
...
<tr><td bgcolor="A9C6E2"  align=center width=20%>REG_id</td><td bgcolor="A9C6E2"  align=center width=40%>Name of the staff</td><td bgcolor="A9C6E2"  align=center width=20%>proffession</td><td bgcolor="A9C6E2"  align=center width=20%>Total Salary</td></tr>
<%while(rs2.next())
 {
String str=rs2.getString(3);%>
<tr><td bgcolor="#EFEFEF"  align=center width=20%><a href="viewstaff2.jsp?t3=<%=str%>"><%=str%></td><td bgcolor="#EFEFEF"  align=center width=40%><%=rs2.getString(2)%>&nbsp;.&nbsp;<%=rs2.getString(1)%></td><td bgcolor="#EFEFEF"  align=center width=20%><%=rs2.getString(8)%></td><td bgcolor="#EFEFEF"  align=center width=20%><%=rs2.getString(9)%></td></tr>
 <%}%>
</table></td></tr>
