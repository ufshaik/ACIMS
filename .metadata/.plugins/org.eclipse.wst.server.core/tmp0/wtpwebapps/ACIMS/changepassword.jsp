...
<table width="800" border="1" bordercolor="#0077c0" bgcolor=white>
...
<%}%> 
<tr><td height="30"><center><h2><font color="#336699">Change Password</font></h2>
<form name=frm1 method="POST" action="colchgpswd.jsp">
