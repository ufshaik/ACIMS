...
<TR bgColor=#a9c6e2>
                            ...
                            <TD width="15%">
                              <DIV align=center><FONT size=1><B><FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=#000000>College Code</FONT></B></FONT></DIV></TD>
							<TD width="50%">
                              <DIV align=center><FONT size=1><B><FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=#000000>Affiliated 
                              </FONT></B></FONT></DIV></TD>
                               </TR>
<%int i=1; 
	while(rs.next())
...
<TD bgcolor="EFEFEF" align=center><FONT face="Verdana, Arial, Helvetica, sans-serif" color=#000000 size=2>
    <%=i%> </font> 
	 <TD bgcolor="EFEFEF" align=center width="50%"><FONT face="Verdana, Arial, Helvetica, sans-serif" color=#000000 size=2>
     <%=rs.getString(1)%>,
	 <%=rs2.getString(1)%>,<a href="http://<%=website%>" target="_blank"><%=website%></a></font> 
<TD bgcolor="EFEFEF" align=center width="15%"><FONT face="Verdana, Arial, Helvetica, sans-serif" color=#000000 size=2>
     <%=code%></font> 
