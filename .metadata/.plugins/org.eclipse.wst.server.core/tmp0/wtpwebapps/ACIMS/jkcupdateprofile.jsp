...
<Td ><Br>
 ...
 <Tr>
    ...
    <Form name=frm1 method="POST" action="jkcadminupdateprofile.jsp">
   <br>
	<%if(val.equals("1"))
	 { %>
<FONT 
...
<%}%> 
    <Td BgColor=#efefef Align="Center"><Font Size=2 Face=Verdana Color=#336699 ><B>&nbsp;Update Profile&nbsp;</B></Font>
<Tr>   <tr><tr><tr><tr><tr>

 <Tr> 
       
     <Td><Font Color=#DC143C  Face=verdana Size=2 >login ID:</Font></Td>
	 <td>	 <Input type=text  Size=10 name=logid value=<%=rs1.getString(1)%> readonly>

   <Tr> 
       
     <Td><Font Color=#DC143C  Face=verdana Size=2 >First Name:</Font></Td>
	 <td>	 <Input type=text  Size=20 name=fname value=<%=rs1.getString(2)%>>
	
       
     <Td><Font Color=#DC143C  Face=verdana Size=2 >Last Name:</Font></Td>
	 <td>	 <Input type=text  Size=20 name=lname value=<%=rs1.getString(3)%>>
	 <Tr> 
       
     <Td><Font Color=#DC143C  Face=verdana Size=2 >Email ID:</Font></Td>
	 <td>	 <Input type=text  Size=20 name=em value=<%=rs1.getString(4)%>>
	 
       
     <Td><Font Color=#DC143C  Face=verdana Size=2 >Contact Number:</Font></Td>
	 <td>	 <Input type=text  Size=20 name=contact value=<%=rs1.getString(5)%>></td></tr>
     <tr><td height=10>  
