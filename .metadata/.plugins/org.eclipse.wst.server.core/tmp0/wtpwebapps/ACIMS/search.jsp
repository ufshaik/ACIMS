...
else
{
    %><Table align=center border=0 width=98% >
	<tr><td height=300>
	<b><center><FONT face="Verdana, Arial, Helvetica, sans-serif" color=red size=2>Your search returned no results.<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; No articles from were found in the index.<br><br></center></font>
