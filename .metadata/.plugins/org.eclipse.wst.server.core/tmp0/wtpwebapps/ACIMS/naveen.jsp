...
<TD vAlign=top bgcolor=white height=350 >
 ...
 <table  >
 <tr><td align=center><P><B><FONT color=#145da6 size=4><U>Naveen Kumar.B</FONT></B></P></td></tr>
<tr><td ><FONT face="Verdana, Arial, Helvetica, sans-serif" 
                        color=#000000 size=2>
	
		       <br><br> <h4>  I am Naveen Kumar.I got  Selected for Infosys<br>
My team project is  Accrdiated College Information Management<br>
System.My Contribution to the Project is JKC Admin Module,and documentation<br><br><br><br>

<font color=orange face=verdana size=2px>    Telephone:</font><br><br>
