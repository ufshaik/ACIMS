...
<tr><td><%if(vv.equals("1"))
	{%><font color=green size=4px>No data found</font><%}%>
	<%if(vv.equals("2"))
	{%><font color=green size=4px>Successfully selected</font><%}%>
	<%if(vv.equals("3"))
	{%><font color=green size=4px>Successfully deleted</font><%}%></tr></td>
</table>

<form action="selectnotification1.jsp" method="post">
<table align=center width=500>
<caption><font color="#0077c0" size=4px>Select notifications</font></caption>
<tr><td bgcolor="A9C6E2" height=20 align=center></td><td bgcolor="A9C6E2" height=20 align=center>sno</td><td bgcolor="A9C6E2" height=20 align=center>postdate</td><td bgcolor="A9C6E2" height=20 align=center>lastdate</td><td bgcolor="A9C6E2" height=20 align=center>Notification</td></tr>
<%int i=1;while(rs.next())
	{String n=rs.getString(1);
     String nm="ch"+i;
	 String nm1="id"+i;
	 %>
        <tr><td bgcolor="#EFEFEF" height=20 align=center width="5%"><input type="checkbox" name=<%=nm%>></td><td bgcolor="#EFEFEF" height=20 align=center width="5%"><input type="hidden" value=<%=n%> name=<%=nm1%>><%=n%>
		</td><td bgcolor="#EFEFEF" height=20 align=center width="15%"><%=rs.getString(2)%></td><td bgcolor="#EFEFEF" height=20 align=center width="15%"><%=rs.getString(3)%></td><td bgcolor="#EFEFEF" height=20 align=center><%=rs.getString(4)%></td></tr>
		<%i++;}%>
		<tr><td height=30></td></tr>
		<tr><td colspan=3 align=center><input type=submit name=f value=submit></td><td colspan=2 align=center><input type=submit name=f value=delete></td></tr>
</table>
</form>
