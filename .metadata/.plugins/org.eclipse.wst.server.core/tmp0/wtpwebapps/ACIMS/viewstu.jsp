...
<%if(vv.equals("2"))
	  {%>
	      <font color=green face=verdena size=4px>Registration-id not found</font>
	<%}%>
</center>
<table align=center>
<tr><td height="50"></td></tr>
<tr><td><form action="view.jsp" method="post">

<table border=0  align=center height=300>


<caption><u><font color="#0077c0"><b>STUDENT DETAILS FORM</u></caption>
<tr><td height="10"></td></tr>

<tr><td height="10"></td></tr><tr><td  valign=top><h4>Enter the Roll Number:</h4></td><td valign=top><input type=text size=15 name="t3" value="Enter No."></td></tr>
<tr><td valign=top>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=submit name=s1 value="Submit"></td>
<td  valign=top><input type=reset name=r1 value="Reset"></td></tr>
