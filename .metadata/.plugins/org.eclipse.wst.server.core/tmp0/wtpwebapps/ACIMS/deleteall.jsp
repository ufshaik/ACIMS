...
<tr><td><table width="800" border="1" height="500" bgcolor=white>
...
<form action="deleteall1.jsp" method="post">
...
<tr><td align=center><%if(vv.equals("1"))
		 ...
		 if(vv.equals("2"))
	     {%><font color="red" size=3px>Course is invalid</font><%}
		  if(vv.equals("2"))
	     {%><font color="red" size=3px>Deleted sucessfully</font><%}%>


	  </td></tr>
	  <tr><td height="50" align=top></td></tr>

	  <tr><td align=center><h4><font color="#336699">Enter student Branch and course to delete student details</font></h4></td></tr>
