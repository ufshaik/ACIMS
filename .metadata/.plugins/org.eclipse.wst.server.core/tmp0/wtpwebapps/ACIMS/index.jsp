...
if (validate_required(name1,"Name field must be filled out!")==false)
  {name1.focus();return false}
if (validate_required(email1,"email-id field must be filled out!")==false)
  {email1.focus();return false}
if (validate_required(feedback,"Feedback field must be filled out!")==false)
  ...
  <tr><td valign=top class=to width="780" >
       <table width="820" cellpadding=0 cellspacing=0 height="174">
            <tr>
             ...
             <tr><td width="822" height="10"><IMG height=40 src="img/m021.jpg" width=326 ><A
			  href="index.jsp"><IMG 
                onmouseover="this.src='img/buttons/home.gif'" onmouseout="this.src='img/buttons/home1.gif'" 
               alt=Home 
               src="img/buttons/home1.gif" width="93" height="40"></A><A
			  onmouseover="openMenu('naac',this,-20,0);" 
...
new fadeshow(fadeimages, 305, 200, 5, 2200, 0, "R")
              </script></td>
        </tr>
        </table>
...
<td colspan=2 align=center><FONT 
                              ...
                              color=#006699 size=3><b><u>Enter your FeedBack</b></font></td></tr>
<tr ><td height=5></td></tr>
<tr><td valign=top>
<form name=frm method=post onsubmit="return validate_form(this)" action="dbcode/addfeedback.jsp" >
<table valign=top>
		...
		<tr>
			...
			<table cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<td><input type="submit" value="search college" border="0" hspace="7"></td>
				</tr>
			</table>
			</td></form></tr>
...
<table cellpadding=0 cellspacing=0 width="826" >
  <tr><td width="48"><IMG height=36 src="img/m33.gif" width=42 align=left ></td>
    <td class=fo width="740">All Rights Reserved. </td>
    <td align=right width="230" class=fo><IMG height=36 src="img/m35.gif" width=220></td></tr>
 </table></td></tr>
</table>
...
<LI id=jkc>&nbsp;<A href=""></A><UL>
  ...
  <LI><A href="umarabout.html">P.Ravindra</A></LI>
    <LI><A href="umarabout.html">Shaik Umar</A></LI>
    <LI><A href="umarabout.html">Siva Mallick</A></LI>
        <LI><A href="umarabout.html">Mohan</A></LI>
