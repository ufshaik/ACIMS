...
try
 {
  ...
  rs.next();
  System.out.print("resultset created");
...
<tr><td vAlign=center align=middle rowSpan=2>
   ...
   <TR>
                            ...
                            <FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=#ffffff size=2>
                             <a class=links href="newrequests.jsp">New Requests(<%=rs5.getString(1)%>)</FONT></TD></TR>
...
<TR>
                            ...
                            <FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=#ffffff size=2>
                             <a class=links href="logout.jsp">Logout</FONT></TD></TR>
							 <TR><TD vAlign=center align=middle colSpan=2>
<IMG height=1 src="D2_Blueline.gif" width="98%"></TD></TR>
</font></table>
</td>
