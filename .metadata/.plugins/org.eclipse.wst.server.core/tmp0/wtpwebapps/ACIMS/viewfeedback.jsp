...
try
 {
  ...
  String s1="select * from feedbacks order by sno ";
...
<form name=frm method=post action="delfeedback.jsp">
...
<TD bgcolor="EFEFEF" align=center><FONT face="Verdana, Arial, Helvetica, sans-serif" color=#000000 size=2>
     <input type=checkbox name="checked<%=x%>" ></font> </input>
	 <TD bgcolor="EFEFEF" align=center><FONT face="Verdana, Arial, Helvetica, sans-serif" color=#000000 size=2>
     <%=rs1.getString(2)%></font> 
	 <TD bgcolor="EFEFEF" align=center><FONT face="Verdana, Arial, Helvetica, sans-serif" color=#000000 size=2>
   ...
   <%}%>
<tr><td><br>
<tr><td><td><td align=right><input type="submit" value="  Delete  "></form>
</Tbody>
</Table>
</Tbody>
</Table>
