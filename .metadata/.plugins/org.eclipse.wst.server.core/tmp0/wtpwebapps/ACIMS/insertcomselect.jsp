...
aci=con.prepareStatement("select distinct year from jkcdata");
...
<tr><td  bgcolor="#EFEFEF"></td><td bgcolor="A9C6E2" height=20 align=center>Name of the company</td><td bgcolor="A9C6E2" height=20 align=center width=20%>Year</td><td bgcolor="A9C6E2" height=20 align=center>Number os students selected</td></tr><tr>
<%  int i=1;
while(rs2.next())
	{

	 aci1=con.prepareStatement("select distinct company from jkcdata");
	 rs1=aci1.executeQuery();
	 while(rs3.next())
		{
		 
		  aci2=con.prepareStatement("select company,year,count(*) from jkcdata where company='"+rs3.getString(1)+"' and year='"+rs2.getString(2)+"'");
		  rs4=aci2.executeQuery();
		  while(rs4.next())
			{
			  String s="ch"+i;
			  %>
			  <tr><td bgcolor="#EFEFEF" height=20 align=center width="5%"><input type="checkbox" name=<%=s%>></td><td bgcolor="#EFEFEF" height=20 align=center><%=rs3.getString(1)%></td><td bgcolor="#EFEFEF" height=20 align=center><%=rs2.getString(2)%></td><td bgcolor="#EFEFEF" height=20 align=center><%=rs4.getString(3)%></td>
</tr>
<%
        }
		}
...
<tr><td></td><td></td><td></td><td><input type="submit" value="delete"></td><tr>
</form>
