...
<Td><Br>
 ...
 <Tr>
    ...
    <Form name=frm1 method="POST" action="changegr.jsp">
    <br>
	<%if(val.equals("1"))
	 { %>
<center><FONT 
...
<%}
 ...
 <center><FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=red size=2><h4><b>College Name and Code doesn't match</h4></b></font></center>
 <%}%> 
    <Td BgColor=#efefef Align="Center"><Font Size=2 Face=Verdana Color=#336699 ><B>&nbsp;Change Grade&nbsp;</B></Font>
<Tr>   <tr><tr><tr><tr><tr>
<Td>
<Tr> 
      
     <Td><Font Color=#DC143C  Face=verdana Size=2 >Name Of Institute:</Font></td><Td>
	 <select name=inname >
    ...
    <Tr> 
     ...
     <Td><Font Color=#DC143C  Face=verdana Size=2 >Code of Institute:</Font></Td>
...
<%while(rs2.next())
 ...
 <Tr> 
     ...
     <Td><Font Color=#DC143C  Face=verdana Size=2 >New Grade&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
     :</Font><Td><select name=newgrade >
<option name=newgrade>....
<option name=newgrade>A++ 
<option name=newgrade>A+
<option name=newgrade>A
<option name=newgrade>B++
<option name=newgrade>B+
<option name=newgrade>B
<option name=newgrade>C++
<option name=newgrade>C+
   ...
   <Td Align=Right><Input type=Submit Value=" Change " size=10></Input>
</Form>
</Tbody>
</Table>
