...
rs=st.executeQuery("select noteid,postdate,lastdate,notify from notifications order by noteid");
%>
<HTML>
 <HEAD>
...
<tr><td bgcolor="A9C6E2" align=center><FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=black size=2>Sno</td>
<td bgcolor="A9C6E2" align=center><FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=black size=2>Posted Date</td>
<td bgcolor="A9C6E2" align=center><FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=black size=2>Last Date</td>
<td bgcolor="A9C6E2" align=center><FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=black size=2>Notification</td>
<%

while(rs.next())
{%>
     <tr><td bgcolor="efefef" align=center><FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=black size=2><%=rs.getString(1)%></font></td>
<td bgcolor="efefef" align=center><FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=black size=2><%=rs.getString(2)%></font></td>
<td bgcolor="efefef" align=center><FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=black size=2><%=rs.getString(3)%></font></td>
 <td bgcolor="efefef" align=center><FONT 
                              face="Verdana, Arial, Helvetica, sans-serif" 
                              color=black size=2><%=rs.getString(4)%></font></td>
